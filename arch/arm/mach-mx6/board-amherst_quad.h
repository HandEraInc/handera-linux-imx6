/*
 * Copyright (C) 2013-2014 HandEra, Inc. All Rights Reserved.
 *
...
#ifndef _BOARD_AMHERST_QUAD_H
#define _BOARD_AMHERST_QUAD_H
#include <mach/iomux-mx6q.h>

static iomux_v3_cfg_t amherst_quad_pads[] = {
	/* AUDMUX */
	...
	MX6Q_PAD_EIM_D25__ECSPI2_SS3,	// Out to option board
	...
	MX6Q_PAD_GPIO_3__GPIO_1_3,	// nRST
	MX6Q_PAD_GPIO_16__ENET_ANATOP_ETHERNET_REF_OUT, // IEEE 1588 clock
	MX6Q_PAD_KEY_COL2__GPIO_4_10,	// RMII Interrupt
	...
	MX6Q_PAD_EIM_D22__GPIO_3_22,		// OTG_VBUS_EN (use as GPIO)

	/* USB Host */
	MX6Q_PAD_EIM_D30__USBOH3_USBH1_OC,
	MX6Q_PAD_EIM_D31__GPIO_3_31,		// HOST_VBUS_EN (to be removed)
	...
	MX6Q_PAD_GPIO_4__GPIO_1_4, 		// SD2_CDF
	MX6Q_PAD_GPIO_2__GPIO_1_2, 		// SD2_WP
	MX6Q_PAD_GPIO_18__GPIO_7_13,		// SD2_PWR_EN
	...
	/* GPIOs */
	MX6Q_PAD_SD3_DAT4__GPIO_7_1,	// WF_PWRDNF
	MX6Q_PAD_SD3_RST__GPIO_7_8,	// WF_RSTF
	MX6Q_PAD_SD3_DAT5__GPIO_7_0,	// WF_WAKEUP

	/* Option PWM */
	MX6Q_PAD_SD1_DAT2__PWM2_PWMO,	// GPIO1[19]

	/* Display PWM and Control */
	MX6Q_PAD_GPIO_9__PWM1_PWMO,	// GPIO1[9], EXT_PWM
	MX6Q_PAD_EIM_D19__GPIO_3_19,	// EXT_VID_EN

	/* Relay */
	MX6Q_PAD_EIM_D20__GPIO_3_20,	// EXT_RELAY

	/* PCIe */
	MX6Q_PAD_CSI0_DATA_EN__GPIO_5_20,  // PCIE_WAKEF
	MX6Q_PAD_GPIO_17__GPIO_7_12,	   // PCIE_RSTF
	MX6Q_PAD_KEY_ROW3__GPIO_4_13,	   // PCIE_DISF

	/* LEDs */
	MX6Q_PAD_DISP0_DAT7__GPIO_4_28, // LED_BLU
	MX6Q_PAD_DISP0_DAT8__GPIO_4_29, // LED_GRN

	/* GPIOs */
	MX6Q_PAD_EIM_D23__GPIO_3_23,		// GPIO3[23]
	MX6Q_PAD_DISP0_DAT9__GPIO_4_30,		// GPIO4[30]
	MX6Q_PAD_DISP0_DAT10__GPIO_4_31,	// GPIO4[31]
	MX6Q_PAD_DISP0_DAT11__GPIO_5_5,		// GPIO5[5]
	MX6Q_PAD_DISP0_DAT12__GPIO_5_6,		// GPIO5[6]
	MX6Q_PAD_DISP0_DAT13__GPIO_5_7,		// GPIO5[7]
	MX6Q_PAD_DISP0_DAT14__GPIO_5_8,		// GPIO5[8]
	MX6Q_PAD_DISP0_DAT15__GPIO_5_9,		// GPIO5[9]
	MX6Q_PAD_DISP0_DAT16__GPIO_5_10,	// GPIO5[10]
	MX6Q_PAD_DISP0_DAT17__GPIO_5_11,	// GPIO5[11]
	MX6Q_PAD_DISP0_DAT18__GPIO_5_12,	// GPIO5[12]
	MX6Q_PAD_DISP0_DAT19__GPIO_5_13,	// GPIO5[13]
	MX6Q_PAD_DISP0_DAT20__GPIO_5_14,	// GPIO5[14]
	MX6Q_PAD_DISP0_DAT21__GPIO_5_15,	// GPIO5[15]
	MX6Q_PAD_DISP0_DAT22__GPIO_5_16,	// GPIO5[16]
	MX6Q_PAD_DISP0_DAT23__GPIO_5_17,	// GPIO5[17]
	MX6Q_PAD_CSI0_PIXCLK__GPIO_5_18,	// GPIO5[18]
	MX6Q_PAD_CSI0_MCLK__GPIO_5_19,		// GPIO5[19]
	MX6Q_PAD_CSI0_VSYNC__GPIO_5_21,		// GPIO5[21]
};

static iomux_v3_cfg_t amherst_quad_hdmi_ddc_pads[] = {
	MX6Q_PAD_EIM_EB2__HDMI_TX_DDC_SCL, /* HDMI DDC SCL */
	MX6Q_PAD_EIM_D16__HDMI_TX_DDC_SDA, /* HDMI DDC SDA */
};

static iomux_v3_cfg_t amherst_quad_i2c2_pads[] = {
